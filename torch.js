  ...
  run: [
    // windows nvidia
    {
      ...
      "params": {
        ...
        "message": "pip install torch==2.3.1 torchvision==0.18.1 torchaudio==2.3.1 {{args && args.xformers ? 'xformers' : ''}} --index-url https://download.pytorch.org/whl/nightly/cu121"
      }
    },
    // windows amd
    {
